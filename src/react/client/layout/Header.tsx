    ...
    <header>
      ...
      <div className="flex justify-between items-center py-3 px-3 mx-auto w-full max-w-8xl lg:px-4">
        <div className="flex items-center">
          ...
          <div id="docsearch" className="ml-6 xl:ml-16 xl:pl-4">
        ...
        <div className="flex items-center">
          <ul id="flowbiteMenu" className="hidden flex-col pt-6 lg:flex-row lg:self-center lg:py-0 lg:flex">
            ...
            <li className="mb-3 lg:px-2 xl:px-3 lg:mb-0">
              <a href="/blocks/" className="text-sm font-medium text-gray-900 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-500">
                Blocks
              </a>
            </li>
            <li className="mb-3 lg:px-2 xl:px-3 lg:mb-0">
              <a href="/figma/" className="text-sm font-medium text-gray-900 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-500">
                Figma
              </a>
            </li>
            <li className="mb-3 lg:px-2 xl:px-3 lg:mb-0">
              <a href="/resources/" className="text-sm font-medium text-gray-900 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-500">
                Resources
              </a>
            </li>
            <li className="mb-3 lg:px-2 xl:px-3 lg:mb-0">
              <a href="/pro/" className="text-sm font-medium text-gray-900 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-500">
                Pro version
              </a>
            </li>
          </ul>
          ...
          <a
            href="/pro/#pricing"
            className="md:hidden inline-flex items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ml-3"
          >
            Pricing
          </a>
          <a
            href="/pro/#pricing"
            className="hidden md:inline-flex items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ml-3"
          >
            Pricing &amp; FAQ
          </a>
        </div>
